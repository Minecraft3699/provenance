...
import net.mc3699.provenance.archetype.archetypes.TestArchetype;
...
public class ProvArchetypes {
    ...
    public static final Supplier<BaseArchetype> TEST = ARCHETYPES.register("test", TestArchetype::new);
